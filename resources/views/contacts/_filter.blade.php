            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Search..." id="txt_search" name="search" value="{{request()->query('search')}}" aria-label="Search..." aria-describedby="button-addon2">
